...
" Set tabline
source ~/.vim/plugins/set_tabline/plugin/set_tabline.vim
...
" Undo Tree
map <leader>nu :UndotreeToggle<cr>
...
noremap <silent> <leader>o :Buffers<CR>
noremap <silent> \ :Rg<Cr>
noremap <silent> K :Rg<C-R><C-W><CR>
